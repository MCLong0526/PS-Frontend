...
const ProfileDropdown = () => {
    ...
    const displayPoints = profile?.points ?? null;
                ...
                <DropdownToggle tag="button" type="button" className="btn">
                    <span className="d-flex align-items-center">
                        ...
                        <span className="text-start ms-xl-2">
                            ...
                            <span className="d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text">{displayEmail}</span>
                        </span>
                    </span>
                </DropdownToggle>
                    ...
                    {displayPoints !== null && (
                        <DropdownItem className='p-0'>
                            <Link to="/pages-profile" className="dropdown-item">
                                <i className="mdi mdi-star-circle text-muted fs-16 align-middle me-1"></i>
                                <span className="align-middle">Points : <b>{displayPoints}</b></span>
                            </Link>
                        </DropdownItem>
                    )}
                    <DropdownItem className='p-0'>
